...
import com.puyuntech.ycmall.dao.BaseDao;
import com.puyuntech.ycmall.entity.BaseEntity;
import com.puyuntech.ycmall.entity.OrderEntity;

/**
 * 
 * DaoImpl - 基类. 
 * Created on 2015-8-25 下午4:07:27 
 * @author Liaozhen
 * @param <T>
 * @param <ID>
 */
public abstract class BaseDaoImpl<T extends BaseEntity<ID>, ID extends Serializable> implements BaseDao<T, ID> {
	...
	/** 别名前缀 */
	private static final String ALIAS_PREFIX = "puyunGeneratedAlias";

...
public class Member extends BaseEntity<Long> {
	...
	/** 返利 */
	private Set<Rebates> rebates=new HashSet<Rebates>();
	
	/** 反馈 */
	private Set<Feedback> feedbacks=new HashSet<Feedback>();
	
	/** 抢购记录 */
	private Set<GrabSeckillLog> grabSeckillLogs=new HashSet<GrabSeckillLog>(); 
	...
	/** 收藏商品 */
	private Set<Product> favoriteGoods = new HashSet<Product>();
	...
	@Column(name="f_username",nullable = false, updatable = false, unique = true)
	 ...
	 * @return 积分
	 */
	@Column(name="f_point",nullable = false)
	 ...
	 * @return 神币
	 */
	@Column(name="f_godMoney",nullable = false, precision = 27, scale = 2)
	public BigDecimal getGodMoney() {
		return godMoney;
	}
	 ...
	 *            神币
	 */
	public void setGodMoney(BigDecimal godMoney) {
		this.godMoney = godMoney;
	}
	 ...
	 * @return 消费金额
	 */
	@Column(name="f_amount",nullable = false, precision = 27, scale = 12)
	 ...
	 * @return 是否锁定
	 */
	@Column(name="f_is_locked",nullable = false)
	 ...
	 * @return 连续登录失败次数
	 */
	@Column(name="f_login_failure_count",nullable = false)
	 ...
	 * @return 注册IP
	 */
	@Column(name="f_register_ip",nullable = false, updatable = false)
	 ...
	 * @return 登录插件ID
	 */
	@Column(name="f_login_plugin_id",updatable = false)
	 ...
	 * @return openID
	 */
	@Column(name="f_open_id",updatable = false)
	 ...
	 * @return 锁定KEY
	 */
	@Column(name="f_lock_key",nullable = false, updatable = false)
	 ...
	 */
	@OneToMany(mappedBy = "member", fetch = FetchType.LAZY, cascade = CascadeType.REMOVE)
	public Set<Rebates> getRebates() {
		return rebates;
	}

	public void setRebates(Set<Rebates> rebates) {
	 ...
	 */
	@OneToMany(mappedBy = "member", fetch = FetchType.LAZY, cascade = CascadeType.REMOVE)
	public Set<GrabSeckillLog> getGrabSeckillLogs() {
		return grabSeckillLogs;
	}

	public void setGrabSeckillLogs(Set<GrabSeckillLog> grabSeckillLogs) {
		this.grabSeckillLogs = grabSeckillLogs;
	}
			...
			if (memberAttribute.getPropertyIndex() != null) {
				try {
					...
					if (StringUtils.isNotEmpty(propertyValue)) {
						return com.puyuntech.ycmall.util.JsonUtils.toObject(propertyValue, List.class);
					}
				} catch (IllegalAccessException e) {
					throw new RuntimeException(e.getMessage(), e);
				} catch (InvocationTargetException e) {
	...
	@JoinTable(name = "t_member_favorite_products", joinColumns = { @JoinColumn(name = "f_favorite_members", referencedColumnName = "f_id") }, inverseJoinColumns = { @JoinColumn(name = "f_favorite_products", referencedColumnName = "f_id") })
	@OrderBy("createDate desc")
	public Set<Product> getFavoriteGoods() {
	 ...
	 *            收藏商品
	 */
	public void setFavoriteGoods(Set<Product> favoriteGoods) {

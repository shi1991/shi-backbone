 ...
 * 
 * Entity - 统计 . 
 * Created on 2015-8-28 下午5:55:01 
 * @author 施长成
 */
@Entity
...
public class Statistic extends BaseEntity<Long> {
	...
	private static final long serialVersionUID = 768010491418536053L;
	 ...
	 * @return 年
	 */
	@Column(name="f_year",nullable = false, updatable = false)
	 ...
	 * @return 月
	 */
	@Column(name="f_month",nullable = false, updatable = false)
	 ...
	 * @return 日
	 */
	@Column(name="f_day",nullable = false, updatable = false)
	 ...
	 * @return 会员注册数
	 */
	@Column(name="f_register_member_count",nullable = false, updatable = false)
	 ...
	 * @return 订单创建数
	 */
	@Column(name="f_create_order_count",nullable = false, updatable = false)
	 ...
	 * @return 订单完成数
	 */
	@Column(name="f_complete_order_count",nullable = false, updatable = false)
	 ...
	 * @return 订单创建金额
	 */
	@Column(name="f_create_order_amount",nullable = false, updatable = false, precision = 21, scale = 6)
	 ...
	 * @return 订单完成金额
	 */
	@Column(name="f_complete_order_amount",nullable = false, updatable = false, precision = 21, scale = 6)

 ...
 */
@Entity
@Table(name = "t_stock_trans_check_item")
public class StockTransCheckItem extends BaseEntity<Long> {
	...
	@ManyToMany
	@JoinTable(name="t_stock_trans_check_productsn",joinColumns = {@JoinColumn(name = "t_stock_trans_check_item", referencedColumnName = "f_id") }, inverseJoinColumns = { @JoinColumn(name = "f_product_sn", referencedColumnName = "f_id") } )

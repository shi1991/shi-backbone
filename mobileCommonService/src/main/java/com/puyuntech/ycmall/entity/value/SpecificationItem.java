...
/**
 * 
 * Entity - 规格项 . Created on 2015-8-27 下午1:38:13
 * 
 * @author 施长成
 */
public class SpecificationItem implements Serializable {

	private static final long serialVersionUID = 6245344330076449612L;
	...
	public boolean isValid(SpecificationValue specificationValue) {
		if (specificationValue != null && specificationValue.getId() != null
			...
			for (SpecificationItem.Entry entry : getEntries()) {
				if (entry != null
						&& entry.getIsSelected()
						&& specificationValue.getId().equals(entry.getId())
	...
	public List<String> getSelectedOptions() {
		List<SpecificationItem.Entry> entrys = getEntries();
	...
	public static class Entry implements Serializable {
		...
		private static final long serialVersionUID = 2156789571233168627L;
